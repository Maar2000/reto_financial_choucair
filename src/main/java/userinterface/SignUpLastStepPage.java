...
public class SignUpLastStepPage {
    ...
    public static final Target CHECK_TERMS_OF_USE = Target.the("where do we write the password")
            .located(By.xpath("//body/ui-view[1]/main[1]/section[1]/div[1]/div[2]/div[1]/div[2]/div[1]/form[1]/div[5]/label[1]/span[1]"));

    public static final Target CHECK_PRIVACY_AND_POLICY = Target.the("where do we write the password")
            .located(By.xpath("//body/ui-view[1]/main[1]/section[1]/div[1]/div[2]/div[1]/div[2]/div[1]/form[1]/div[6]/label[1]/span[1]"));

    public static final Target COMPLETE_SETUP_BUTTON4 = Target.the("where do we write the password")
