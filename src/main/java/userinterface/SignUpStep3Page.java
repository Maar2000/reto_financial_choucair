...
public class SignUpStep3Page {
    ...
    public static final Target SELECT_COMPUTER_OPTION = Target.the("where do we select the windows option")
    ...
    public static final Target MOBILE_DEVICE_LIST = Target.the("where do we look the country list")
    ...
    public static final Target INPUT_SELECT_MOBILE_DEVICE =Target.the("where do we write the country hint")
    ...
    public static final Target SELECT_MOBILE_DEVICE_OPTION = Target.the("where do we select the country")
    ...
    public static final Target MOBILE_MODEL_LIST = Target.the("where do we look the country list")
    ...
    public static final Target INPUT_SELECT_MOBILE_MODEL =Target.the("where do we write the country hint")
    ...
    public static final Target SELECT_MOBILE_MODEL_OPTION = Target.the("where do we select the country")
    ...
    public static final Target SELECT_OPERATING_SYSTEM_OPTION = Target.the("where do we select the windows option")
            .located(By.xpath("//div[contains(text(),'Android 11')]"));

    public static final Target NEXT_LAST_STEP_BUTTON3 = Target.the("where do we write or select the city")
